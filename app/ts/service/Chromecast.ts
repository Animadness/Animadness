...
module Animadness {
    class ChromecastService {
        ...
        constructor(
            ...
            this.currentVideo = {
                src: 'https://animadness.net/media/intro.mp4',
        ...
        initializeCastPlayer() {
            ...
            var applicationID = this.enjin.google.chromecast.applicationId;
        ...
        sessionListener(e) {
            ...
            if (this.session) {
                ...
                if (this.session.media[0]) {
                    ...
                    this.loadMedia(this.epLink, 'Animadness', '/img/icon.png');
                }
    ...
    angular.module('Animadness').service('Chromecast', ChromecastService);
}
